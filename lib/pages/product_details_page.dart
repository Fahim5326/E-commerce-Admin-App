      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text('After discount: ${provider.priceAfterDiscount(productModel.price, productModel.discount)}',
            ...
            trailing: IconButton(
              onPressed: () {
                showSingleTextInputDialogue(
                    ...
                    title: 'Update Price',
                    onSave: (value) {
                      provider.updateProductField(id, 'price', num.parse(value));
                    });
              },
